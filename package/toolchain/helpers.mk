...
check_kernel_headers_version = \
	if ! tools/support/scripts/check-kernel-headers.sh $(1) $(2) $(3) \
...
#
gen_gdbinit_file = \
	mkdir -p $(STAGING_DIR)/usr/share/luban/ ; \
	echo "add-auto-load-safe-path $(STAGING_DIR)" > $(STAGING_DIR)/usr/share/luban/gdbinit ; \
	echo "set sysroot $(STAGING_DIR)" >> $(STAGING_DIR)/usr/share/luban/gdbinit
