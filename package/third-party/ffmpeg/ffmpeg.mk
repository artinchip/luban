...
ifeq ($(BR2_PACKAGE_FFMPEG_WEBP),y)
FFMPEG_CONF_OPTS += --enable-libwebp
FFMPEG_CONF_OPTS += --enable-muxer=webp
FFMPEG_CONF_OPTS += --enable-decoder=webp
FFMPEG_CONF_OPTS += --enable-encoder=libwebp
FFMPEG_CONF_OPTS += --enable-parser=webp
FFMPEG_DEPENDENCIES += webp
else
FFMPEG_CONF_OPTS += --disable-libwebp
endif
...
define FFMPEG_CONFIGURE_CMDS
	(cd $(FFMPEG_BUILDDIR) && rm -rf config.cache && \
