...
SKELETON_INIT_COMMON_ADD_LINUX_HEADERS_DEPENDENCY = NO

# The skeleton also handles the merged /usr case in the sysroot
SKELETON_INIT_COMMON_INSTALL_STAGING = YES
SKELETON_INIT_COMMON_ENABLE_TARBALL = NO
SKELETON_INIT_COMMON_ENABLE_PATCH = NO
SKELETON_INIT_COMMON_GEN_PREBUILT_TARBALL = NO

SKELETON_INIT_COMMON_PATH = package/system/skeleton
...
define SKELETON_INIT_COMMON_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 0644 tools/support/misc/target-dir-warning.txt \
...
define SKELETON_INIT_COMMON_SET_HOSTNAME
	...
	$(Q)$(SED) '$$a \127.0.1.1\t$(SKELETON_INIT_COMMON_HOSTS_LINE)' \
...
define SKELETON_INIT_COMMON_SET_ROOT_PASSWD
	$(Q)$(SED) s,^root:[^:]*:,root:$(SKELETON_INIT_COMMON_ROOT_PASSWORD):, $(TARGET_DIR)/etc/shadow
endef
...
define SKELETON_INIT_COMMON_ADD_SH_TO_SHELLS
	$(Q)grep -qsE '^/bin/sh$$' $(TARGET_DIR)/etc/shells \
...
define SKELETON_INIT_COMMON_SET_BIN_SH
	$(Q)ln -sf $(SKELETON_INIT_COMMON_BIN_SH) $(TARGET_DIR)/bin/sh
	$(Q)$(SED) '/^root:/s,[^/]*$$,$(SKELETON_INIT_COMMON_BIN_SH),' \
