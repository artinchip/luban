...
SKELETON_INIT_SYSV_ADD_LINUX_HEADERS_DEPENDENCY = NO

SKELETON_INIT_SYSV_DEPENDENCIES = skeleton-init-common

SKELETON_INIT_SYSV_PROVIDES = skeleton

SKELETON_INIT_SYSV_ENABLE_TARBALL = NO
SKELETON_INIT_SYSV_ENABLE_PATCH = NO
SKELETON_INIT_SYSV_GEN_PREBUILT_TARBALL = NO
...
define SKELETON_INIT_SYSV_SWAPON_SWAPOFF_INITTAB
	$(Q)if [ -x $(TARGET_DIR)/sbin/swapon -a -x $(TARGET_DIR)/sbin/swapoff ]; then \
