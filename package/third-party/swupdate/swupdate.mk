...
define SWUPDATE_INSTALL_TARGET_CMDS
	...
	$(if $(BR2_PACKAGE_SWUPDATE_INSTALL_WEBSITE), \
		...
		cp -dpfr $(SWUPDATE_SRCDIR)/examples/www/v2/* $(TARGET_DIR)/var/www/swupdate)
endef
...
define SWUPDATE_INSTALL_INIT_SYSV
	...
	$(INSTALL) -D -m 755 $(SWUPDATE_PKGDIR)/S80swupdate \
		$(TARGET_DIR)/usr/lib/S80swupdate
	$(INSTALL) -D -m 755 $(SWUPDATE_PKGDIR)/S90swupdate \
		$(TARGET_DIR)/etc/init.d/S90swupdate
