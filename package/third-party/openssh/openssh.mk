...
define OPENSSH_INSTALL_SYSTEMD_SYSUSERS
	$(INSTALL) -m 0644 -D package/third-party/openssh/sshd-sysusers.conf \
...
define OPENSSH_INSTALL_INIT_SYSTEMD
	$(INSTALL) -D -m 644 package/third-party/openssh/sshd.service \
		$(TARGET_DIR)/usr/lib/systemd/system/sshd.service
	$(OPENSSH_INSTALL_SYSTEMD_SYSUSERS)
endef

define OPENSSH_INSTALL_INIT_SYSV
	$(INSTALL) -D -m 755 package/third-party/openssh/S50sshd \
