...
define MTD_INSTALL_LIBS
	$(INSTALL) -D -m 0755 $(MTD_SRCDIR)/include/libmtd.h $(STAGING_DIR)/usr/include/libmtd.h
	$(INSTALL) -D -m 0755 $(MTD_SRCDIR)/include/libubi.h $(STAGING_DIR)/usr/include/libubi.h
	$(INSTALL) -D -m 0755 $(MTD_SRCDIR)/include/mtd/ubi-media.h $(STAGING_DIR)/usr/include/mtd/ubi-media.h
