...
#
# So, all tools refer to $(LINUX_SRCDIR) instead of $(@D).
...
include $(sort $(wildcard package/third-party/linux-tools/*.mk.in))

# We only need the kernel to be extracted, not actually built
LINUX_TOOLS_PATCH_DEPENDENCIES = linux
LINUX_TOOLS_ENABLE_TARBALL = NO
LINUX_TOOLS_ENABLE_PATCH = NO
LINUX_TOOLS_GEN_PREBUILT_TARBALL = NO
LINUX_TOOLS_ADD_LINUX_HEADERS_DEPENDENCY = NO
