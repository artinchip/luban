...
QT5BASE_ARCH_CONFIG_FILE = $(QT5BASE_SRCDIR)/mkspecs/devices/linux-buildroot-g++/arch.conf
...
define QT5BASE_CONFIGURE_HOSTCC
	$(SED) 's,^QMAKE_CC\s*=.*,QMAKE_CC = $(HOSTCC),' $(QT5BASE_SRCDIR)/mkspecs/common/g++-base.conf
	$(SED) 's,^QMAKE_CXX\s*=.*,QMAKE_CXX = $(HOSTCXX),' $(QT5BASE_SRCDIR)/mkspecs/common/g++-base.conf
endef
...
define QT5BASE_CONFIGURE_CMDS
	mkdir -p $(QT5BASE_SRCDIR)/mkspecs/devices/linux-buildroot-g++/
	sed 's/@EGLFS_DEVICE@/$(QT5BASE_EGLFS_DEVICE)/g' \
		$(QT5BASE_PKGDIR)/qmake.conf.in > \
		$(QT5BASE_SRCDIR)/mkspecs/devices/linux-buildroot-g++/qmake.conf
	$(INSTALL) -m 0644 -D $(QT5BASE_PKGDIR)/qplatformdefs.h \
		$(QT5BASE_SRCDIR)/mkspecs/devices/linux-buildroot-g++/qplatformdefs.h
