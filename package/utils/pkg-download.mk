...
DL_WRAPPER = tools/support/download/dl-wrapper
...
ifeq ($(origin PACKAGES_DIR),undefined)
PACKAGES_DIR ?= $(call qstrip,$(BR2_PACKAGES_DIR))
ifeq ($(PACKAGES_DIR),)
PACKAGES_DIR := $(TOPDIR)/source
endif
else
# Restore the BR2_DL_DIR that was overridden by the .config file
BR2_PACKAGES_DIR = $(PACKAGES_DIR)
endif
