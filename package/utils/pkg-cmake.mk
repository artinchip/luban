...
$(3)_SUPPORTS_IN_SOURCE_BUILD ?= NO
...
define $(2)_CONFIGURE_CMDS
	...
	$$($$(PKG)_CONF_ENV) $$(BR2_CMAKE) $$($$(PKG)_SRCDIR) \
		-DCMAKE_TOOLCHAIN_FILE="$$(HOST_DIR)/share/luban/toolchainfile.cmake" \
...
define $(2)_BUILD_CMDS
	$(Q)$$(HOST_MAKE_ENV) $$($$(PKG)_MAKE_ENV) $$($$(PKG)_MAKE) $$($$(PKG)_MAKE_OPTS) -C $$($$(PKG)_BUILDDIR)
endef
endif
endif
...
define $(2)_INSTALL_CMDS
	$(Q)$$(HOST_MAKE_ENV) $$($$(PKG)_MAKE_ENV) $$($$(PKG)_MAKE) $$($$(PKG)_MAKE_OPTS) $$($$(PKG)_INSTALL_OPTS) -C $$($$(PKG)_BUILDDIR)
endef
endif
...
define $(2)_INSTALL_STAGING_CMDS
	$(Q)$$(TARGET_MAKE_ENV) $$($$(PKG)_MAKE_ENV) $$($$(PKG)_MAKE) $$($$(PKG)_MAKE_OPTS) $$($$(PKG)_INSTALL_STAGING_OPTS) -C $$($$(PKG)_BUILDDIR)
endef
endif
...
# based on the toolchainfile.cmake file's location: $(HOST_DIR)/share/luban
...
define TOOLCHAIN_CMAKE_INSTALL_FILES
	...
	sed \
		...
		$(TOPDIR)/tools/support/misc/toolchainfile.cmake.in \
		> $(HOST_DIR)/share/luban/toolchainfile.cmake
	$(Q)$(INSTALL) -D -m 0644 tools/support/misc/Buildroot.cmake \
		$(HOST_DIR)/share/luban/Platform/Buildroot.cmake
endef
