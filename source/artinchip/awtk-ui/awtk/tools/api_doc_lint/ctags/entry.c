...
static EntryCallbackFunc entry_callback = NULL; /*entry callback support*/
static void * entry_callback_param = NULL;
int ctags_reg_callback(EntryCallbackFunc fun, void *param)
{
  entry_callback = fun;
  entry_callback_param = param;
  return 0; /*0 mean sucess*/
}
