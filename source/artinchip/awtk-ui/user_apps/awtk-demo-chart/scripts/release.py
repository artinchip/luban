...
DEMO_NAME = 'demo.exe' if OS_NAME == 'Windows' else 'demo'
...
def copyExe():
  ...
  common.copyFile(BIN_DIR, DEMO_NAME, output_bin_dir, DEMO_NAME)
  common.copySharedLib(BIN_DIR, output_bin_dir)

  os.chmod(join_path(output_bin_dir, DEMO_NAME), 0o755)
