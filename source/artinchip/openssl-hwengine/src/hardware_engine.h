...
#ifndef OPENSSL_AIC_HARDWARE_ENGINE_H
#define OPENSSL_AIC_HARDWARE_ENGINE_H
...
#define DES_KEY_SIZE_192 24
#define DES_IV_LEN 8

struct aic_ossl_cipher_ctx {
