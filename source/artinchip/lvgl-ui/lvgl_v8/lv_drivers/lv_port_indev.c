...
void encoder_evdev_read(lv_indev_drv_t * drv, lv_indev_data_t * data)
{
...
void lv_port_indev_init(void)
{
    ...
    lv_indev_drv_init(&indev_drv_encoder); /*Basic initialization*/
    indev_drv_encoder.type = LV_INDEV_TYPE_ENCODER;
    indev_drv_encoder.read_cb = encoder_evdev_read;
