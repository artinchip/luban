...
if (BUILD_SHARED_LIBS)
  message(NOTICE "build shared lvgl lib")
  add_library(lvgl SHARED ${SOURCES})
else()
  message(NOTICE "build static lvgl lib")
...
# use aic memory
if(DEFINED USE_AIC_MEM)
  if(${USE_AIC_MEM} STREQUAL "yes")
      add_definitions(-DUSE_AIC_MEM)
      find_library(LIBTS libaic_mem.so)
      target_link_libraries(lvgl ${LIBTS})
  endif()
endif()
...
target_include_directories(lvgl SYSTEM PUBLIC ${LVGL_ROOT_DIR} ${LVGL_ROOT_DIR}/../ ${LVGL_ROOT_DIR}/../../ ${LV_CONF_CUSTOM_PATH})

# Include /examples folder
target_include_directories(lvgl_examples SYSTEM
                           PUBLIC ${LVGL_ROOT_DIR}/examples ${LVGL_ROOT_DIR}/../  ${LVGL_ROOT_DIR}/../ ${LV_CONF_CUSTOM_PATH})
target_include_directories(lvgl_demos SYSTEM
                           PUBLIC ${LVGL_ROOT_DIR}/demos ${LVGL_ROOT_DIR}/../  ${LVGL_ROOT_DIR}/../../ ${LV_CONF_CUSTOM_PATH})
