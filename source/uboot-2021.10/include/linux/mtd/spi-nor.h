...
#define SPINOR_MX_OP_PP_1_1_4 0x38	/* Micron Quad page program */
#define SPINOR_AT_OP_PP_1_1_4 0x33	/* Atmel Quad page program */
...
/* Used for enable quad. */
#define SR_QUAD_EN_BIT6		BIT(6)
#define SR_QUAD_EN_BIT1		BIT(1)
