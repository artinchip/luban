...
/* UHS_EXT register defines */
#define SDMMC_UHS_EXT_CLK_MSK		(0x3U << 30)
#define SDMMC_UHS_EXT_CLK(n)		_SBF(30, (n))
#define SDMMC_UHS_EXT_PHASE_MSK		(0x3U << 28)
#define SDMMC_UHS_EXT_PHASE(n)		_SBF(28, (n))
#define SDMMC_UHS_EXT_DELAY_MSK		(0x1fU << 23)
#define SDMMC_UHS_EXT_DELAY(n)		_SBF(23, (n))
