...
enum cts_device_fw_reg {
    ...
    CTS_DEVICE_FW_REG_RAW_DATA_SELF_CAP_RX = 0x26c0,
    CTS_DEVICE_FW_REG_RAW_DATA_SELF_CAP_TX = 0x2708,
    ...
    CTS_DEVICE_FW_REG_DIFF_DATA_SELF_CAP = 0x9000,
...
enum cts_devict_hw_reg {
	CTS_DEVICE_HW_REG_PINMUX			   = (0x040400 + 0x0004),
	CTS_DEVICE_HW_REG_GPIO_DIR			   = (0x040400 + 0x0010),
	CTS_DEVICE_HW_REG_GPIO_SET_VAL		   = (0x040400 + 0x0011),
	CTS_DEVICE_HW_REG_GPIO_GET_VAL		   = (0x040400 + 0x0012),
	CTS_DEVICE_HW_REG_GPIO_PULL_DOWN	   = (0x040400 + 0x0018),
	CTS_DEVICE_HW_REG_GPIO_PULL_UP		   = (0x040400 + 0x001A),
};	
...
extern int cts_is_glove_enabled(struct cts_device *cts_dev);
#else
