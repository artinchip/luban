...
{
	struct uvcg_control_class_group *group = NULL;
	group =	container_of(i, struct uvcg_control_class_group,
			     group.cg_item);
...
{
	struct uvcg_streaming_class_group *group = NULL;
	group =	container_of(i, struct uvcg_streaming_class_group,
			     group.cg_item);
