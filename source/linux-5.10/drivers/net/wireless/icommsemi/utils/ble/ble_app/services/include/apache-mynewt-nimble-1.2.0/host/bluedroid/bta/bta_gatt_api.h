...
typedef UINT8 tGATT_FORMAT;//++ssv
...
#define GATT_MAX_READ_MULTI_HANDLES      10           /* Max attributes to read in one request */// ssv++
...
typedef UINT8 tGATT_AUTH_REQ;//ssv++
...
typedef tBT_TRANSPORT tBTA_TRANSPORT;//ssv++
typedef struct {
    tBTA_GATT_STATUS    status;
    UINT16              conn_id;
    tBTA_GATTC_IF       client_if;
...
#define GATT_MAX_ATTR_LEN                   600//ssv++
...
typedef UINT16 tGATT_DISCONN_REASON;//++ssv
