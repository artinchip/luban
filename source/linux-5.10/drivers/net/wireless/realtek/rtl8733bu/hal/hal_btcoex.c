...
void halbtcoutsrc_reduce_wl_tx_power(void *pBtcContext, s8 tx_power)
{
	...
	if (IS_HARDWARE_TYPE_8822C(pBtCoexist->Adapter) || IS_HARDWARE_TYPE_8733B(pBtCoexist->Adapter)
...
u8 EXhalbtcoutsrc_BindBtCoexWithAdapter(void *padapter)
{
	...
	if(IS_HARDWARE_TYPE_8822C(padapter)) {
		...
		pBtCoexist->chip_para = &btc_chip_para_8192f;
			...
			pBtCoexist->chip_type = BTC_CHIP_RTL8733B;
			pBtCoexist->chip_para = &btc_chip_para_8733b;
		}
#endif
#endif
#ifdef CONFIG_RTL8822E
