...
#if (RTL8822C_SUPPORT || RTL8812F_SUPPORT || RTL8197G_SUPPORT || RTL8733B_SUPPORT ||\
...
struct dm_struct {
	...
	u32			bp_0x9b0;
	#elif (RTL8733B_SUPPORT || RTL8735B_SUPPORT)
	u8			txagc_buff[2][PHY_NUM_RATE_IDX];
	u32			bp_0x9b0;
	#endif
	#if (RTL8822C_SUPPORT || RTL8733B_SUPPORT || RTL8735B_SUPPORT ||\
		RTL8730A_SUPPORT || RTL8822E_SUPPORT)
