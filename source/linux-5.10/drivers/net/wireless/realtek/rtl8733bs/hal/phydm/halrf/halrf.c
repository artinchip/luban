...
#if (RTL8733B_SUPPORT == 1)
	case ODM_RTL8733B:
		halrf_rfk_power_save_8733b(dm, is_power_save);
	break;
#endif
#if (RTL8814C_SUPPORT == 1)
		case ODM_RTL8814C:
...
#if (RTL8733B_SUPPORT == 1)
		case ODM_RTL8733B:
			halrf_rfk_handshake_8733b(dm, is_before_k);
			break;
#endif
#if (RTL8814C_SUPPORT == 1)
		case ODM_RTL8814C:
...
#if (RTL8733B_SUPPORT == 1)
		case ODM_RTL8733B:
			phy_iq_calibrate_8733b(dm, false);
			break;
#endif
#if (RTL8814C_SUPPORT == 1)
		case ODM_RTL8814C:
...
#if (RTL8733B_SUPPORT == 1)
		case ODM_RTL8733B:
			phy_iq_calibrate_8733b(dm, is_recovery);
			break;
#endif
#if (RTL8814C_SUPPORT == 1)
		case ODM_RTL8814C:
...
halrf_config_rfk_with_header_file(void *dm_void, u32 config_type)
{
	...
	if (dm->support_ic_type == ODM_RTL8733B) {
		if (config_type == CONFIG_BB_RF_CAL_INIT)
			odm_read_and_config_mp_8733b_cal_init(dm);
	}
#endif
#if (RTL8814C_SUPPORT == 1)
	if (dm->support_ic_type == ODM_RTL8814C) {
...
void halrf_spur_compensation(void *dm_void)
{
	...
	case ODM_RTL8733B:
		halrf_rfk_power_save(dm, false);
		halrf_spur_compensation_8733b(dm);
		halrf_rfk_power_save(dm, true);
		break;
#endif
	default:
...
#if (RTL8733B_SUPPORT == 1)
	if (dm->support_ic_type & ODM_RTL8733B)
		return halrf_tssi_set_de_8733b(dm, tssi_value);
#endif
#if (RTL8814C_SUPPORT == 1)
	if (dm->support_ic_type & ODM_RTL8814C)
...
#if (RTL8733B_SUPPORT == 1)
	if (dm->support_ic_type & ODM_RTL8733B)
		return halrf_get_online_tssi_de_8733b(dm, path, pout);
#endif
	return 0;
}
