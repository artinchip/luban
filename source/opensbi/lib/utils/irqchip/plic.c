...
static void plic_enable_smode(struct  plic_data *plic)
{
	volatile void *plic_priority = (void *)plic->addr + PLIC_CTRL_S;
	writel(1, plic_priority);
}
