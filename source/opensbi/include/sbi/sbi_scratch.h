...
/** Offset of Artinchip boot param */
#define SBI_SCRATCH_BOOT_PARAM_OFFSET		(11 * __SIZEOF_POINTER__)
...
#define sbi_scratch_thishart_options() \
	((unsigned long)(sbi_scratch_thishart_ptr()->options))
